                    ...
                    <CardContent className="p-4 space-y-3">
                      <div className="flex items-start gap-2 p-2 rounded-lg bg-slate-100/60 border border-slate-200/40">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="font-medium text-slate-800 text-xs mb-1">Locations:</p>
                          <p className="text-slate-700 text-xs truncate">{event.locations.join(" • ")}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 p-2 rounded-lg bg-slate-100/60 border border-slate-200/40">
                        ...
                        <div>
                          <p className="font-medium text-slate-800 text-xs mb-1">Format:</p>
                          <p className="text-slate-700 text-xs">{event.format}</p>
                        </div>
                      </div>
